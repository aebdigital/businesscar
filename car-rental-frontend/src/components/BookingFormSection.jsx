        ...
        <FadeInUp delay={0.2}>
          ...
          <div>
            ...
            <select
              ...
              className="w-full text-white px-3 py-2 text-sm rounded-md border border-gray-700 focus:border-orange-500 focus:outline-none appearance-none disabled:opacity-50"
          ...
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="w-full text-white px-3 py-2 rounded-md border border-gray-700 focus:border-orange-500 focus:outline-none appearance-none"
              style={{backgroundColor: '#191919'}}
            >
